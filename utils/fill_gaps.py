...
def fill_gaps(datapath, group_cols=['API_NUMBER', 'TABLE_NAME'], sort_col='TOP' , target_col='Stratcode', target='dg', match_type='contains', export_path=None):
    ...
    export_path : str or pathlike object, by default=None, optional
    ...
    if export_path is not None:
        out_logsWithDG.to_csv(export_path, index_label='ID')
